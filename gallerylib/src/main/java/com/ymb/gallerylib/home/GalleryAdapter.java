...
import com.ymb.gallerylib.util.AnimationHelper;
 ...
 */
class GalleryAdapter extends RecyclerView.Adapter<com.ymb.gallerylib.home.GalleryAdapter.ViewHolder> {
    ...
    @Override
    public com.ymb.gallerylib.home.GalleryAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, @ViewType int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull com.ymb.gallerylib.home.GalleryAdapter.ViewHolder holder, int position) {
     ...
     */
    @Override
    public void onBindViewHolder(com.ymb.gallerylib.home.GalleryAdapter.ViewHolder holder, int position, List<Object> payloads) {
